...
useSeoMeta({
  title: 'Décrets - Documenthèque',
  ogTitle: 'Décrets - Documenthèque',
  description: 'Consultez et téléchargez les décrets officiels',
  ogDescription: 'Consultez et téléchargez les décrets officiels'
})
</script>
