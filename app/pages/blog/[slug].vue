    ...
    <UContainer class="py-12">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8">
          <article class="bg-white dark:bg-gray-900 rounded-3xl shadow-sm p-8 md:p-12 border border-gray-100 dark:border-gray-800">
            ...
            <div
              ...
              class="mb-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-l-4 border-blue-600"
            >
          ...
          <div
            ...
            class="mt-8 bg-white dark:bg-gray-900 rounded-3xl shadow-sm p-6 md:p-8 border border-gray-100 dark:border-gray-800"
          >
              ...
              >
                ...
                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center">
                  <UIcon
                    ...
                    class="text-white w-10 h-10 opacity-0 group-hover:opacity-100 transition-opacity"
                  />
                </div>
              </div>
            </div>
          ...
          <div class="mt-8 bg-white dark:bg-gray-900 rounded-3xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
            <h4 class="font-bold mb-4 text-sm uppercase tracking-widest text-gray-500">
        ...
        <div class="lg:col-span-4 space-y-6">
          ...
          <div
            ...
            class="bg-white dark:bg-gray-900 rounded-3xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm"
          >
            <h4 class="font-bold mb-4 uppercase text-xs tracking-widest text-gray-500 flex items-center gap-2">
          ...
          <div class="bg-gradient-to-br from-green-900 to-blue-900 rounded-3xl p-6 text-white shadow-sm">
            <h4 class="font-bold mb-4 uppercase text-xs tracking-widest">
              Navigation
            </h4>
            <div class="space-y-3">
              <NuxtLink
      ...
      >
        <div class="flex items-center gap-3 mb-8">
          ...
          <div class="flex-1 h-px bg-gradient-to-r from-blue-500 to-transparent" />
        </div>
