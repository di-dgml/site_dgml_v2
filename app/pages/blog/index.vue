  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="relative bg-gradient-to-r from-green-900 to-blue-900/70 text-white overflow-hidden">
      ...
      <div class="absolute bottom-0 left-0 right-0">
        ...
        >
          <path
            d="M0 22L60 26.3C120 30.7 240 39.3 360 39.3C480 39.3 600 30.7 720 26.3C840 22 960 22 1080 24.7C1200 27.3 1320 32.7 1380 35.3L1440 38V54H1380C1320 54 1200 54 1080 54C960 54 840 54 720 54C600 54 480 54 360 54C240 54 120 54 60 54H0V22Z"
            :fill="$colorMode.value === 'dark' ? '#111827' : '#f9fafb'"
          />
        </svg>
      </div>
    </div>
    ...
    >
      ...
      <div class="text-center mb-12">
        ...
        <div class="flex items-center justify-center gap-3">
          <div class="h-px w-16 bg-gradient-to-r from-transparent via-blue-500 to-transparent" />
          <svg
      ...
      >
        ...
        <article
          v-if="posts[0]"
          class="lg:col-span-12 bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300"
        >
          <div class="lg:flex">
            <div class="lg:w-1/2">
              <img
