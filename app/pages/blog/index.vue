...
// SEO
useSeoMeta({
  title: 'Actualités - Direction Générale du Matériel et de la Logistique',
  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
    ...
    <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <article v-if="posts[0]" class="lg:col-span-12 bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
          <div class="lg:flex">
            <div class="lg:w-1/2">
              <img 
